function mobileCalc() {
	...
	function mke_progr(val,mn,mx,lim) {
		...
		div.scl=100/(mx-mn);
		div.tbl=div.appendChild(mbr_mketbl([["","",""],[""]],"width=100%, height=100%, border=0, cellspacing=0, cellpadding=0"));
	...
	mwin.body.oiltbl=mbr_mketbl(moiltbl,"width=100%, cellpadding=2, cellspacing=2, border=0, class=mOils");
	mwin.body.proptbl=mbr_mketbl(proptbl,"width=100%, cellpadding=0, cellspacing=0, border=1, class=mProp");
	...
	mwin.body.maintbl=mwin.body.appendChild(mbr_mketbl([[theads[1]],[mwin.body.oiltbl],[theads[2]],[mwin.body.proptbl],[theads[3]],[mwin.body.progrtbl]],"width=100%, cellspacing=0, cellpadding=0, border=0, class=mTbl"));
