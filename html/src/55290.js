...
//			frame.frame.onmousemove=window.onmousemove;
//			frame.frame.onmouseup=window.onmouseup=function() {frame.frame.onmousemove=window.onmousemove=null; frame.frame.onmousedown=window.onmousedown=function() {return true;}}
			window.onmouseup=function() {window.onmousemove=null; window.onmousedown=function() {return true;}}
//			frame.frame.onmousedown=window.onmousedown=function() {return false;}
	...
	this.up.onclick=function() {if(!_this.disabled){_this.inp.value=_this.val+1; _this.inp.onchange();} return false;}
	this.down.onclick=function() {if(!_this.disabled){_this.inp.value=_this.val-1; _this.inp.onchange();} return false;}
	this.up.onmouseover=this.down.onmouseover=function() {this.style.backgroundColor="#0f0";}
	this.up.onmouseout=this.down.onmouseout=function() {this.style.backgroundColor="#ddd";}
